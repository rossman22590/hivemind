...
var IndexMetaDatabaseIndexConfig_1 = require("./IndexMetaDatabaseIndexConfig");
var IndexMetaDatabaseStatus_1 = require("./IndexMetaDatabaseStatus");
/**
...
function IndexMetaDatabaseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'dimensions': !(0, runtime_1.exists)(json, 'dimensions') ? undefined : json['dimensions'],
        ...
        'status': !(0, runtime_1.exists)(json, 'status') ? undefined : (0, IndexMetaDatabaseStatus_1.IndexMetaDatabaseStatusFromJSON)(json['status']),
    };
}
...
function IndexMetaDatabaseToJSON(value) {
    ...
    return {
        ...
        'status': (0, IndexMetaDatabaseStatus_1.IndexMetaDatabaseStatusToJSON)(value.status),
    };
}
exports.IndexMetaDatabaseToJSON = IndexMetaDatabaseToJSON;
//# sourceMappingURL=IndexMetaDatabase.js.map