            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    try {
                        ...
                        return [2 /*return*/, Promise.reject(new Error("".concat(json === null || json === void 0 ? void 0 : json.message)))];
                    }
                    catch (e) {
                        return [2 /*return*/, Promise.reject(new Error("PineconeClient: Error calling ".concat(func.name.replace("bound ", ""), ": ").concat(text)))];
                    }
                    return [3 /*break*/, 6];
...
var PineconeClient = /** @class */ (function () {
    ...
    PineconeClient.prototype.getProjectName = function (controllerPath, apiKey) {
        return __awaiter(this, void 0, void 0, function () {
            var whoami, request, response, project_name, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.log("PineconeClient: Error getting project name: ".concat(error_1));
                        return [3 /*break*/, 5];
    ...
    PineconeClient.prototype.init = function (configuration) {
        return __awaiter(this, void 0, void 0, function () {
            var environment, apiKey, controllerPath, _a, controllerConfigurationParameters, controllerConfiguration, indexOperations;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
